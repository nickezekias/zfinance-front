                ...
                <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#react-mask-5)">
                  <g id="Body" transform="translate(32.000000, 36.000000)">
                    ...
                    <path
                      ...
                      id="Neck-Shadow" fill-opacity="0.100000001" fill="#000000" mask="url(#react-mask-6)" />
                  </g>
...
.notification-item {
  ...
  margin: 0.5rem 0;
  /* Reduced margin from 10px to 8px */
...
.notification-content {
  ...
  /* Allow shrinking */
  margin-right: 0.5rem;
  /* Reduced space between content and ellipsis button */
  min-width: 0;
...
.notification-description {
  margin: 0.25rem 0;
  /* Reduced margin from 5px to 4px */
  font-size: 0.8rem;
  /* Reduced size from 14px to 13px */
  color: #555;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
.notification-date {
  ...
  /* Reduced margin from 5px to 4px */
  font-size: 0.7rem;
  /* Reduced size from 12px to 11px */
  color: #888;
}
...
@media (prefers-color-scheme: dark) {
  ...
  .ellipsis-button {
    color: #ccc;
    /* Dark mode description and button color */
  }
